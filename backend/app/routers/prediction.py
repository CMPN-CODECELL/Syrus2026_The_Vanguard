...
async def predict_disease(
    ...
    try:
        ...
        # Branch C — Manual blood values JSON
        ...
        # Branch D — Symptom / notes assessment via Gemini
...
Return ONLY a valid JSON array. Each element must have exactly these keys:
  "disease"           (string — condition name)
  "probability"       (float between 0.0 and 1.0)
  "evidence"          (string — brief clinical reasoning)
  "recommended_tests" (array of strings — suggested follow-up tests)
